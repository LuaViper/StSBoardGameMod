...
public class BGDarkling extends AbstractBGMonster implements DieControlledMoves, BGDamageIcons {
    ...
    private static final MonsterStrings monsterStrings =
        CardCrawlGame.languagePack.getMonsterStrings("Darkling");
        ...
        if (this.currentHealth <= 0 && !this.halfDead) {
            ...
            if (!allDead) {
                ...
                if (this.nextMove != 6) {
                    ...
                    AbstractDungeon.actionManager.addToBottom(
                        (AbstractGameAction) new CreateIntentAction(this)
                    );
                    //createIntent();
                }
            } else {
    ...
    public void regrowthCheck() {
        if (this.halfDead) {
            ...
            AbstractDungeon.actionManager.addToBottom(
                (AbstractGameAction) new ChangeStateAction((AbstractMonster) this, "REVIVE")
            );
            AbstractDungeon.actionManager.addToBottom(
                (AbstractGameAction) new ApplyPowerAction(
                    (AbstractCreature) this,
