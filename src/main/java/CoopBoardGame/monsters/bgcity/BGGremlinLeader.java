...
public class BGGremlinLeader extends AbstractBGMonster implements BGDamageIcons {
    ...
    private static final MonsterStrings monsterStrings =
        CardCrawlGame.languagePack.getMonsterStrings("GremlinLeader");
    ...
    public BGGremlinLeader() {
        ...
        if (AbstractDungeon.ascensionLevel < 1) setHp(30);
        else if (AbstractDungeon.ascensionLevel < 12) setHp(35);
        else setHp(40);
        ...
        if (AbstractDungeon.ascensionLevel < 1) this.damage.add(
            new DamageInfo((AbstractCreature) this, 2)
        );
        else this.damage.add(new DamageInfo((AbstractCreature) this, 3));
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 3:
                AbstractDungeon.actionManager.addToBottom(
                    (AbstractGameAction) new ChangeStateAction(this, "CALL")
                );
                AbstractDungeon.actionManager.addToBottom(
                ...
                if (AbstractDungeon.ascensionLevel >= 12) {
                    AbstractDungeon.actionManager.addToBottom(
                        (AbstractGameAction) new BGBuffAllEnemiesAction(this)
                    );
                }
                setMove(
                    (byte) 1,
