...
public class BGBronzeAutomaton extends AbstractBGMonster implements BGDamageIcons {
    ...
    public BGBronzeAutomaton() {
        ...
        loadAnimation(
            "images/monsters/theCity/automaton/skeleton.atlas",
            "images/monsters/theCity/automaton/skeleton.json",
            1.0F
        );
    ...
    public void usePreBattleAction() {
        ...
        if (MathUtils.randomBoolean()) {
            ...
            AbstractDungeon.actionManager.addToBottom(
                (AbstractGameAction) new SFXAction(
                    "MONSTER_AUTOMATON_SUMMON",
                    MathUtils.random(-0.1F, 0.1F)
                )
            );
        }
        AbstractDungeon.actionManager.addToBottom(
            (AbstractGameAction) new SpawnMonsterAction(new BGBronzeOrb(-300.0F, 200.0F, 0), false)
        );
    }
            ...
            case 4:
                AbstractDungeon.actionManager.addToBottom(
                    (AbstractGameAction) new VFXAction(
                        (AbstractGameEffect) new LaserBeamEffect(
                            this.hb.cX,
