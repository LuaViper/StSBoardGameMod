...
public class CoopBoardGame
    ...
    private static final String MODNAME = "Co-op Board Game";
    private static final String AUTHOR = "degraffa";
    private static final String DESCRIPTION =
        "The video game adaptation of the board game adaptation of Slay the Spire, now with co-operative multiplayer!";
    ...
    public static final Color PLACEHOLDER_POTION_HYBRID = CardHelper.getColor(
        255.0f,
        230.0f,
        230.0f
    ); // Near White
    ...
    private static final String CHAR_SELECT_PORTRAIT_IRONCLAD =
    ...
    public static final String BGIRONCLAD_SKELETON_JSON =
        "images/characters/ironclad/idle/skeleton.json";

    public static final String BGSILENT_SKELETON_ATLAS =
        "images/characters/theSilent/idle/skeleton.atlas";
    public static final String BGSILENT_SKELETON_JSON =
        "images/characters/theSilent/idle/skeleton.json";

    public static final String BGDEFECT_SKELETON_ATLAS =
        "images/characters/defect/idle/skeleton.atlas";
    public static final String BGDEFECT_SKELETON_JSON =
        "images/characters/defect/idle/skeleton.json";

    public static final String BGWATCHER_SKELETON_ATLAS =
        "images/characters/watcher/idle/skeleton.atlas";
    public static final String BGWATCHER_SKELETON_JSON =
        ...
        if (!modID.equals(EXCEPTION_STRINGS.DEVID)) {
            ...
            if (!resourcePathExists.exists()) {
                ...
                throw new RuntimeException(
                    EXCEPTION_STRINGS.RESOURCE_FOLDER_EXCEPTION + getModID() + "Resources"
                ); // NOT THIS
            } // NO
        } // NO
    } // NO
    ...
    public void receiveEditCharacters() {
        ...
        BaseMod.addCharacter(
            ...
            CHAR_SELECT_BUTTON_SILENT,
            CHAR_SELECT_PORTRAIT_SILENT,
        ...
        BaseMod.addCharacter(
            ...
            CHAR_SELECT_BUTTON_DEFECT,
            CHAR_SELECT_PORTRAIT_DEFECT,
        ...
        BaseMod.addCharacter(
            ...
            CHAR_SELECT_BUTTON_WATCHER,
            CHAR_SELECT_PORTRAIT_WATCHER,
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledButton unlockButton = new ModLabeledButton(
            "Click here to unlock max Ascension",
            500f,
            500f,
            settingsPanel,
            button -> {
                {
                    Prefs prefs = new BGIronclad(
                        "Prefs Lookup",
                        BGIronclad.Enums.BG_IRONCLAD
                    ).getPrefs();
        ...
        ModLabeledToggleButton multicharButton = new ModLabeledToggleButton(
            "Enable EXPERIMENTAL 4-PLAYER FEATURES",
        ...
        addMonster("CoopBoardGame:Taskmaster", () ->
            new MonsterGroup(
                new AbstractMonster[] {
                    ...
                    new BGTaskmaster(-133.0F, 0.0F),
                    (AbstractMonster) new BGRedSlaver(125.0F, -30.0F),
                }
            )
        );
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGLivingWall.ID, BGLivingWall.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGTheLibrary.ID, BGTheLibrary.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGGoldenIdolEvent.ID, BGGoldenIdolEvent.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGGoldenWing.ID, BGGoldenWing.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGBonfire.ID, BGBonfire.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGTransmogrifier.ID, BGTransmogrifier.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGCleric.ID, BGCleric.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGUpgradeShrine.ID, BGUpgradeShrine.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGGremlinWheelGame.ID, BGGremlinWheelGame.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGAccursedBlacksmith.ID, BGAccursedBlacksmith.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGLab.ID, BGLab.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGBigFish.ID, BGBigFish.class)
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        //Ascension 3
        BaseMod.addEvent(
            new AddEventParams.Builder(BGScrapOoze.ID, BGScrapOoze.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGWorldOfGoop.ID, BGWorldOfGoop.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGDeadAdventurer.ID, BGDeadAdventurer.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGHallwayEncounter.ID, BGHallwayEncounter.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGMerchantEncounter.ID, BGMerchantEncounter.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGExordium.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGGoldShrine.ID, BGGoldShrine.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGCursedTome.ID, BGCursedTome.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGBackToBasics.ID, BGBackToBasics.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGDrugDealer.ID, BGDrugDealer.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGDesigner.ID, BGDesigner.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGWomanInBlue.ID, BGWomanInBlue.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGBeggar.ID, BGBeggar.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGKnowingSkull.ID, BGKnowingSkull.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGANoteForYourself.ID, BGANoteForYourself.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGColosseum.ID, BGColosseum.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGNloth.ID, BGNloth.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGWeMeetAgain.ID, BGWeMeetAgain.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGTheJoust.ID, BGTheJoust.class)
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        //Ascension 3
        BaseMod.addEvent(
            new AddEventParams.Builder(BGTheMausoleum.ID, BGTheMausoleum.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGForgottenAltar.ID, BGForgottenAltar.class)
                .spawnCondition(new Ascension3Condition())
                .dungeonID(BGTheCity.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGPurificationShrine.ID, BGPurificationShrine.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGMindBloom.ID, BGMindBloom.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGTombRedMask.ID, BGTombRedMask.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGFalling.ID, BGFalling.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGSecretPortal.ID, BGSecretPortal.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGWindingHalls.ID, BGWindingHalls.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGSensoryStone.ID, BGSensoryStone.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGTheMoaiHead.ID, BGTheMoaiHead.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(BGFaceTrader.ID, BGFaceTrader.class)
                .dungeonID(BGTheBeyond.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
        ...
        BaseMod.addEvent(
            new AddEventParams.Builder(FakeMonsterRoomEvent.ID, FakeMonsterRoomEvent.class)
                .dungeonID(BGTheEnding.ID)
                .playerClass(BGIronclad.Enums.BG_IRONCLAD)
                .playerClass(BGSilent.Enums.BG_SILENT)
                .playerClass(BGDefect.Enums.BG_DEFECT)
                .playerClass(BGWatcher.Enums.BG_WATCHER)
    ...
    public void receiveEditKeywords() {
        ...
        String json = Gdx.files
            .internal(getModID() + "Resources/localization/eng/DefaultMod-Keyword-Strings.json")
            .readString(String.valueOf(StandardCharsets.UTF_8));
        com.evacipated.cardcrawl.mod.stslib.Keyword[] keywords = gson.fromJson(
            json,
