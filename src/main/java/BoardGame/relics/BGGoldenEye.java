...
public class BGGoldenEye extends AbstractBGRelic implements ClickableRelic {
    public static final String ID = "BGGoldenEye";

    public BGGoldenEye() {
        super("BGGoldenEye", "golden_eye.png", AbstractRelic.RelicTier.RARE, AbstractRelic.LandingSound.HEAVY);
    }
