...
public class BGTestLouse extends AbstractBGMonster implements BGDamageIcons, DieControlledMoves {
    ...
    public BGTestLouse(float x, float y) {
        super(NAME, "BGTestLouse", 17, 0.0F, -5.0F, 180.0F, 140.0F, null, x, y);
        ...
        logger.info("BGTestLouse: behavior "+behavior);
