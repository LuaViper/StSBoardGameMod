...
//        addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new MayhemPower((AbstractCreature)p, this.magicNumber), this.magicNumber));
//    }
//
//
