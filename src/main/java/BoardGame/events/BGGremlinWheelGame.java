        ...
        extends AbstractImageEvent
{
    ...
    private float bounceTimer = 1.0F, animTimer = 3.0F; private boolean startSpin = false; private boolean finishSpin = false; private boolean doneSpinning = false; private boolean bounceIn = true;
    private float spinVelocity = 200.0F; private int goldAmount;
    ...
    private static final float START_Y = Settings.OPTION_Y + 1000.0F * Settings.scale; private static final float TARGET_Y = Settings.OPTION_Y;
    private float imgX = Settings.WIDTH / 2.0F; private float imgY = START_Y; private float wheelAngle = 0.0F;
