...
public class BGPlayDrawnCardAction extends AbstractGameAction {
    private boolean exhaustCards;

    public BGPlayDrawnCardAction(boolean exhausts) {
...
//                addToTop(new BGPlayDrawnCardAction(this.exhaustCards));
